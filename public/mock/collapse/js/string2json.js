...
//  var json = $id("RawJson").value;
  ...
  try{
    ...
    $id("Canvas").innerHTML = "<PRE class='CodeContainer' style='background-color: white;border-color: white;'>" + html + "</PRE>";
  }catch(e){
    alert("JSON���ݸ�ʽ����ȷ:\n"+e.message);
    $id("Canvas").innerHTML = "";
  }
...
function ProcessError(json) {
    ...
    try {
        ...
        var obj = eval("[" + json + "]");
        html = ProcessObject(obj[0], 0, false, false, false);
        $id("CanvasError").innerHTML = "<PRE class='CodeContainer' style='background-color: white;border-color: white;'>" + html + "</PRE>";
    } catch (e) {
        alert("JSON���ݸ�ʽ����ȷ:\n" + e.message);
