...
rsync -r --exclude "node_modules" --exclude ".svn" --exclude ".git" --exclude "public/vendor" --exclude "public/mock" $DirToBackup root@115.29.160.155:/data && ssh root@115.29.160.155 "pkill node" > ~/ropsync_p.log 2>&1 &
