...
const _env = require("../key.json").env;
...
const constant = {
    pro:{
        ...
        ROPRequestType:1,
        generateROPStandardRequest(type) {return (type == 1)?"?method=ruixue.rop.frontend.api.data.get&&format=json&&access_token=BCB8D371-EBF1-4549-A272-EAFE7F342DBF":{"method":"ruixue.rop.api.data.get","format":"json","access_token":"BCB8D371-EBF1-4549-A272-EAFE7F342DBF"}},
    ...
    test:{
        ...
        templateList: ["pagination","tree_view","stepper","datatable","fixed_table","logger"],
        ROPRequestType:1,
        generateROPStandardRequest(type) {return (type == 1)?"?method=ruixue.rop.frontend.api.data.get&&format=json&&access_token=933C10E3-DC2B-4514-9F7A-27478D34B3C5":{"method":"ruixue.rop.api.data.get","format":"json","access_token":"933C10E3-DC2B-4514-9F7A-27478D34B3C5"}},
