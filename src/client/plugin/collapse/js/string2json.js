window.SINGLE_TAB = "  ";
window.ImgCollapsed = "/js/plugin/collapse/css/images/Collapsed.gif";
window.ImgExpanded = "/js/plugin/collapse/css/images/Expanded.gif";
...
//  var json = $id("RawJson").value;
  ...
  try{
    ...
    $id("Canvas").innerHTML = "<PRE class='CodeContainer' style='background-color: transparent;border-color: transparent;'>" + html + "</PRE>";
  }catch(e){
    console.log("JSON Parsing Error in Process():\n"+e.message);
    $id("Canvas").innerHTML = "";
  }
}
function ProcessError(json) {
    ...
    try {
        ...
        var obj = eval("[" + json + "]");
        html = ProcessObject(obj[0], 0, false, false, false);
        $id("CanvasError").innerHTML = "<PRE class='CodeContainer' style='background-color: transparent;border-color: transparent;'>" + html + "</PRE>";
    } catch (e) {
        console.log("JSON Parsing Error in ProcessError():\n"+e.message);
        $id("CanvasError").innerHTML = "";
    }
}
